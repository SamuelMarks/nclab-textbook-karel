...
\begin{figure}[!ht]
%\hspace{-4mm}
\includegraphics[width=8cm]{imgk/logo.png}
\vspace{10mm}
\end{figure}
\vbox{}
\vspace{1.5cm}
...
It will help you acquire important principles of algorithmic thinking 
and procedural programming. Karel 
is a famous educational language created and still used at the Stanford 
University. After taking this introductory course, you will be able to transition 
smoothly to Python and other modern programming languages. NCLab has
a course on Python programming which is a natural continuation of this one.\\[4mm]
...
followed: If you wish to contribute, create a free account at Github and fork the public 
repository {\tt nclab-textbook-karel}. Then, clone your fork into your computer, make local changes, 
commit them, push them into your Github fork, and send us a pull request. We are looking forward! \\[4mm]
