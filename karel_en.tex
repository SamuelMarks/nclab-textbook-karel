...
\noindent
\underline{\em Accessing list items by their index}\\
...
\noindent
An arbitrary object {\tt obj} (integer, real number, text string, another list, etc.) can be appended 
to the end of an existing list {\tt L} using the {\tt append()} function:\\
