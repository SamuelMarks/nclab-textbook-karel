...
This textbook is a community project. It will never be published by a commercial
...
as well as additional exercises (there is never enough of them!). All other parts can be certainly improved as well. 
...
development, maintenance, and user support. In addition to 
...
The course is scheduled to open in January 2013.
}
\vspace{8mm}
...
{\bf List of Authors}
\begin{itemize}
\item Pavel Solin, Professor of Computational Science at the University of Nevada, Reno. 
...
\item Salih Dede, Instructor of Computer
