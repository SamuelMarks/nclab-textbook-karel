...
valued in the future. Karel's language is so simple that you will be able to 
focus on the login of algorithms without struggling with syntax and other 
technicalities. After you went through Karel, learning other programming 
languages will be much easier, as you will already master all important 
...
to {\em extremely tough}. Towards the end of this course there are
tasks that will make your head spin. 
...
whose objective is to teach you the logic of computer programming, and math is 
...
\begin{itemize}
\item {\em Open} will open a file stored in your NCLab account (not on your local computer).
\item {\em Clone} will download a Displayed Project from the database into your account. 
